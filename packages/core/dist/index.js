...
// ../../node_modules/.pnpm/tsup@5.12.8_typescript@4.6.4/node_modules/tsup/assets/cjs_shims.js
...
var require_toFormat = __commonJS({
  "../../node_modules/.pnpm/toformat@2.0.0/node_modules/toformat/toFormat.js"(exports, module2) {
    init_cjs_shims();
...
__export(src_exports, {
  ...
  DeliverTxResponse: () => import_stargate.DeliverTxResponse,
  ErrorCode: () => ErrorCode,
  LiquidityProvider: () => LiquidityProvider,
  Pair: () => Pair,
  Pool: () => Pool,
  WalletType: () => WalletType,
  calculateSwapResultPmtp: () => calculateSwapResultPmtp,
  createPoolKey: () => createPoolKey,
  ...
  getMantissaFromDynamicMantissa: () => getMantissaFromDynamicMantissa,
  getMantissaLength: () => getMantissaLength,
  getNormalizedSwapPrice: () => getNormalizedSwapPrice,
  humanUnitsToAssetAmount: () => humanUnitsToAssetAmount,
  isAmount: () => isAmount,
...
function parseBigintIsh(bigintIsh) {
  return bigintIsh instanceof import_jsbi.default ? bigintIsh : typeof bigintIsh === "bigint" ? import_jsbi.default.BigInt(bigintIsh.toString()) : import_jsbi.default.BigInt(bigintIsh);
}
...
function isFraction(value) {
  return value.quotient instanceof import_jsbi.default;
}
...
var Fraction = class {
  ...
  add(other) {
    ...
    return new Fraction(import_jsbi.default.add(import_jsbi.default.multiply(this.numerator, otherParsed.denominator), import_jsbi.default.multiply(otherParsed.numerator, this.denominator)), import_jsbi.default.multiply(this.denominator, otherParsed.denominator));
  }
  subtract(other) {
    const otherParsed = ensureFraction(other);
    if (import_jsbi.default.equal(this.denominator, otherParsed.denominator)) {
    ...
    return new Fraction(import_jsbi.default.subtract(import_jsbi.default.multiply(this.numerator, otherParsed.denominator), import_jsbi.default.multiply(otherParsed.numerator, this.denominator)), import_jsbi.default.multiply(this.denominator, otherParsed.denominator));
  }
  lessThan(other) {
    const otherParsed = ensureFraction(other);
  ...
  multiply(other) {
    const otherParsed = ensureFraction(other);
    return new Fraction(import_jsbi.default.multiply(this.numerator, otherParsed.numerator), import_jsbi.default.multiply(this.denominator, otherParsed.denominator));
  }
  divide(other) {
    const otherParsed = ensureFraction(other);
    return new Fraction(import_jsbi.default.multiply(this.numerator, otherParsed.denominator), import_jsbi.default.multiply(this.denominator, otherParsed.numerator));
  }
...
function format(_amount, _asset, _options) {
  ...
  if (options.shorthand) {
    return (0, import_numbro.default)(decimal).format(createNumbroConfig(options));
  }
  if (options.space) {
    space = " ";
  }
...
function Amount(source) {
  ...
  if (!(source instanceof import_jsbi3.default) && typeof source !== "bigint" && typeof source !== "string") {
...
function getQuotientWithBankersRounding(fraction) {
  ...
  const aAbs = import_jsbi3.default.greaterThan(a, import_jsbi3.default.BigInt("0")) ? a : import_jsbi3.default.multiply(import_jsbi3.default.BigInt("-1"), a);
  const bAbs = import_jsbi3.default.greaterThan(b, import_jsbi3.default.BigInt("0")) ? b : import_jsbi3.default.multiply(import_jsbi3.default.BigInt("-1"), b);
  let result = import_jsbi3.default.divide(aAbs, bAbs);
  const rem = import_jsbi3.default.remainder(aAbs, bAbs);
  if (import_jsbi3.default.greaterThan(import_jsbi3.default.multiply(rem, import_jsbi3.default.BigInt("2")), bAbs)) {
    result = import_jsbi3.default.add(result, import_jsbi3.default.BigInt("1"));
  } else if (import_jsbi3.default.equal(import_jsbi3.default.multiply(rem, import_jsbi3.default.BigInt("2")), bAbs)) {
    if (import_jsbi3.default.equal(import_jsbi3.default.remainder(result, import_jsbi3.default.BigInt("2")), import_jsbi3.default.BigInt("1"))) {
      result = import_jsbi3.default.add(result, import_jsbi3.default.BigInt("1"));
    }
  }
  if (import_jsbi3.default.greaterThan(a, import_jsbi3.default.BigInt("0")) !== import_jsbi3.default.greaterThan(b, import_jsbi3.default.BigInt("0"))) {
    return import_jsbi3.default.multiply(import_jsbi3.default.BigInt("-1"), result);
  } else {
    return result;
  }
}
...
function toBig(fraction) {
  return (0, import_big2.default)(fraction.toFixed(24));
}
function toAmount(a) {
