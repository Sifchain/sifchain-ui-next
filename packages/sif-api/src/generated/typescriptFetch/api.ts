...
const BASE_PATH = "https://proxies.sifchain.finance/api/vanir/testnet/beta".replace(/\/+$/, "");
...
export const AssetsApiFp = function(configuration?: Configuration) {
    return {
         ...
         * @throws {RequiredError}
         */
        getAssets(options?: any): (fetch?: FetchAPI, basePath?: string) => Promise<Array<GetAssetsResponse>> {
         ...
         * @throws {RequiredError}
         */
        getTokenStats(options?: any): (fetch?: FetchAPI, basePath?: string) => Promise<GetTokenStatsResponse> {
         ...
         * @throws {RequiredError}
         */
        getTokenStatsPMTP(options?: any): (fetch?: FetchAPI, basePath?: string) => Promise<GetTokenStatsPMTPResponse> {
         ...
         * @throws {RequiredError}
         */
        getTokenValue(symbol: string, options?: any): (fetch?: FetchAPI, basePath?: string) => Promise<GetTokenValueResponse> {
 ...
 * @export
 */
export const MarginApiFetchParamCreator = function (configuration?: Configuration) {
    return {
        /**
         ...
         * @throws {RequiredError}
         */
        getMarginHistory(address: string, offset?: number, limit?: number, orderBy?: string, sortBy?: string, options: any = {}): FetchArgs {
            // verify required parameter 'address' is not null or undefined
            if (address === null || address === undefined) {
                throw new RequiredError('address','Required parameter address was null or undefined when calling getMarginHistory.');
            }
            const localVarPath = `/margin/history/{address}`
         ...
         * @throws {RequiredError}
         */
        getMarginOpenPosition(address: string, offset?: number, limit?: number, orderBy?: string, sortBy?: string, options: any = {}): FetchArgs {
            // verify required parameter 'address' is not null or undefined
            if (address === null || address === undefined) {
                throw new RequiredError('address','Required parameter address was null or undefined when calling getMarginOpenPosition.');
            }
            const localVarPath = `/margin/openposition/{address}`
                .replace(`{${"address"}}`, encodeURIComponent(String(address)));
            const localVarUrlObj = url.parse(localVarPath, true);
            const localVarRequestOptions = Object.assign({ method: 'GET' }, options);
            const localVarHeaderParameter = {} as any;
         ...
         * @summary Get margin open position filtered by user
         * @param {string} address Wallet address
         * @param {string} poolSymbol Pool symbol for filtering (e.g., CETH, CUSDC)
         * @param {number} [offset] The number of items to skip before starting to collect the result set
         * @param {number} [limit] The number of items to return
         * @param {string} [orderBy] column to sort by
         * @param {string} [sortBy] direction to sort
         ...
         * @throws {RequiredError}
         */
        getMarginOpenPositionBySymbol(address: string, poolSymbol: string, offset?: number, limit?: number, orderBy?: string, sortBy?: string, options: any = {}): FetchArgs {
            // verify required parameter 'address' is not null or undefined
            if (address === null || address === undefined) {
                throw new RequiredError('address','Required parameter address was null or undefined when calling getMarginOpenPositionBySymbol.');
            }
            // verify required parameter 'poolSymbol' is not null or undefined
            if (poolSymbol === null || poolSymbol === undefined) {
                throw new RequiredError('poolSymbol','Required parameter poolSymbol was null or undefined when calling getMarginOpenPositionBySymbol.');
            }
            const localVarPath = `/margin/openposition/{address}/{poolSymbol}`
                .replace(`{${"address"}}`, encodeURIComponent(String(address)))
                .replace(`{${"poolSymbol"}}`, encodeURIComponent(String(poolSymbol)));
            const localVarUrlObj = url.parse(localVarPath, true);
            const localVarRequestOptions = Object.assign({ method: 'GET' }, options);
            const localVarHeaderParameter = {} as any;
            const localVarQueryParameter = {} as any;
...
export const MarginApiFp = function(configuration?: Configuration) {
    return {
         ...
         * @throws {RequiredError}
         */
        getMarginHistory(address: string, offset?: number, limit?: number, orderBy?: string, sortBy?: string, options?: any): (fetch?: FetchAPI, basePath?: string) => Promise<Array<GetMarginHistoryResponse>> {
            const localVarFetchArgs = MarginApiFetchParamCreator(configuration).getMarginHistory(address, offset, limit, orderBy, sortBy, options);
            return (fetch: FetchAPI = isomorphicFetch, basePath: string = BASE_PATH) => {
                return fetch(basePath + localVarFetchArgs.url, localVarFetchArgs.options).then((response) => {
                    if (response.status >= 200 && response.status < 300) {
                        return response.json();
         ...
         * @throws {RequiredError}
         */
        getMarginOpenPosition(address: string, offset?: number, limit?: number, orderBy?: string, sortBy?: string, options?: any): (fetch?: FetchAPI, basePath?: string) => Promise<Array<GetMarginOpenPositionResponse>> {
            const localVarFetchArgs = MarginApiFetchParamCreator(configuration).getMarginOpenPosition(address, offset, limit, orderBy, sortBy, options);
            return (fetch: FetchAPI = isomorphicFetch, basePath: string = BASE_PATH) => {
                return fetch(basePath + localVarFetchArgs.url, localVarFetchArgs.options).then((response) => {
                    if (response.status >= 200 && response.status < 300) {
                        return response.json();
         ...
         * @throws {RequiredError}
         */
        getMarginOpenPositionBySymbol(address: string, poolSymbol: string, offset?: number, limit?: number, orderBy?: string, sortBy?: string, options?: any): (fetch?: FetchAPI, basePath?: string) => Promise<Array<GetMarginOpenPositionResponse>> {
            const localVarFetchArgs = MarginApiFetchParamCreator(configuration).getMarginOpenPositionBySymbol(address, poolSymbol, offset, limit, orderBy, sortBy, options);
            return (fetch: FetchAPI = isomorphicFetch, basePath: string = BASE_PATH) => {
                return fetch(basePath + localVarFetchArgs.url, localVarFetchArgs.options).then((response) => {
                    if (response.status >= 200 && response.status < 300) {
                        return response.json();
 ...
 * @export
 */
export const MarginApiFactory = function (configuration?: Configuration, fetch?: FetchAPI, basePath?: string) {
    return {
        /**
         * This endpoint returns open position history filtered per user address
         * @summary Get margin trade history filtered by user
         ...
         * @throws {RequiredError}
         */
        getMarginHistory(address: string, offset?: number, limit?: number, orderBy?: string, sortBy?: string, options?: any) {
            return MarginApiFp(configuration).getMarginHistory(address, offset, limit, orderBy, sortBy, options)(fetch, basePath);
        },
        /**
         * This endpoint returns open position history filtered per user address
         * @summary Get margin open position filtered by user
         ...
         * @throws {RequiredError}
         */
        getMarginOpenPosition(address: string, offset?: number, limit?: number, orderBy?: string, sortBy?: string, options?: any) {
            return MarginApiFp(configuration).getMarginOpenPosition(address, offset, limit, orderBy, sortBy, options)(fetch, basePath);
        },
        /**
         * This endpoint returns open position history filtered per user address
         * @summary Get margin open position filtered by user
         ...
         * @throws {RequiredError}
         */
        getMarginOpenPositionBySymbol(address: string, poolSymbol: string, offset?: number, limit?: number, orderBy?: string, sortBy?: string, options?: any) {
            return MarginApiFp(configuration).getMarginOpenPositionBySymbol(address, poolSymbol, offset, limit, orderBy, sortBy, options)(fetch, basePath);
        },
    };
};
...
export class MarginApi extends BaseAPI {
     ...
     * @memberof MarginApi
     */
    public getMarginHistory(address: string, offset?: number, limit?: number, orderBy?: string, sortBy?: string, options?: any) {
        return MarginApiFp(this.configuration).getMarginHistory(address, offset, limit, orderBy, sortBy, options)(this.fetch, this.basePath);
    }
     ...
     * @memberof MarginApi
     */
    public getMarginOpenPosition(address: string, offset?: number, limit?: number, orderBy?: string, sortBy?: string, options?: any) {
        return MarginApiFp(this.configuration).getMarginOpenPosition(address, offset, limit, orderBy, sortBy, options)(this.fetch, this.basePath);
    }
     ...
     * @memberof MarginApi
     */
    public getMarginOpenPositionBySymbol(address: string, poolSymbol: string, offset?: number, limit?: number, orderBy?: string, sortBy?: string, options?: any) {
        return MarginApiFp(this.configuration).getMarginOpenPositionBySymbol(address, poolSymbol, offset, limit, orderBy, sortBy, options)(this.fetch, this.basePath);
    }
...
export const NetworkApiFetchParamCreator = function (configuration?: Configuration) {
    return {
         ...
         * @throws {RequiredError}
         */
        getHistoricalPrice(symbol: string, limit?: number, page?: number, options: any = {}): FetchArgs {
            // verify required parameter 'symbol' is not null or undefined
            if (symbol === null || symbol === undefined) {
        ...
        getLppdReward(address: string, options: any = {}): FetchArgs {
            // verify required parameter 'address' is not null or undefined
            if (address === null || address === undefined) {
                throw new RequiredError('address','Required parameter address was null or undefined when calling getLppdReward.');
            }
            const localVarPath = `/network/lppdReward/{address}`
                .replace(`{${"address"}}`, encodeURIComponent(String(address)));
            const localVarUrlObj = url.parse(localVarPath, true);
            const localVarRequestOptions = Object.assign({ method: 'GET' }, options);
            const localVarHeaderParameter = {} as any;
...
export const NetworkApiFp = function(configuration?: Configuration) {
    return {
         ...
         * @throws {RequiredError}
         */
        cmcTotalDailyVolume(options?: any): (fetch?: FetchAPI, basePath?: string) => Promise<string> {
         ...
         * @throws {RequiredError}
         */
        getCmcSummary(options?: any): (fetch?: FetchAPI, basePath?: string) => Promise<Array<GetSummaryResponse>> {
         ...
         * @throws {RequiredError}
         */
        getDailyPrice(options?: any): (fetch?: FetchAPI, basePath?: string) => Promise<Array<GetDailyPriceResponse>> {
         ...
         * @throws {RequiredError}
         */
        getDispensation(type: string, options?: any): (fetch?: FetchAPI, basePath?: string) => Promise<GetPoolResponse> {
         ...
         * @throws {RequiredError}
         */
        getHistoricalPrice(symbol: string, limit?: number, page?: number, options?: any): (fetch?: FetchAPI, basePath?: string) => Promise<Array<GetHistoricalPriceResponse>> {
            const localVarFetchArgs = NetworkApiFetchParamCreator(configuration).getHistoricalPrice(symbol, limit, page, options);
            return (fetch: FetchAPI = isomorphicFetch, basePath: string = BASE_PATH) => {
                return fetch(basePath + localVarFetchArgs.url, localVarFetchArgs.options).then((response) => {
                    if (response.status >= 200 && response.status < 300) {
                        return response.json();
         ...
         * @throws {RequiredError}
         */
        getLppdReward(address: string, options?: any): (fetch?: FetchAPI, basePath?: string) => Promise<Array<GetPoolResponse>> {
            const localVarFetchArgs = NetworkApiFetchParamCreator(configuration).getLppdReward(address, options);
            return (fetch: FetchAPI = isomorphicFetch, basePath: string = BASE_PATH) => {
                return fetch(basePath + localVarFetchArgs.url, localVarFetchArgs.options).then((response) => {
                    if (response.status >= 200 && response.status < 300) {
                        return response.json();
         ...
         * @throws {RequiredError}
         */
        getNetChange(symbol: string, lpAddress: string, options?: any): (fetch?: FetchAPI, basePath?: string) => Promise<GetLiquidityProviderResponse> {
         ...
         * @throws {RequiredError}
         */
        getNetworkInfo(options?: any): (fetch?: FetchAPI, basePath?: string) => Promise<GetNetworkResponse> {
         ...
         * @throws {RequiredError}
         */
        getRewardConfig(type: string, options?: any): (fetch?: FetchAPI, basePath?: string) => Promise<GetPoolResponse> {
         ...
         * @throws {RequiredError}
         */
        getRewardUser(address: string, options?: any): (fetch?: FetchAPI, basePath?: string) => Promise<Array<GetPoolResponse>> {
         ...
         * @throws {RequiredError}
         */
        getSummary(options?: any): (fetch?: FetchAPI, basePath?: string) => Promise<Array<GetSummaryResponse>> {
...
export const NetworkApiFactory = function (configuration?: Configuration, fetch?: FetchAPI, basePath?: string) {
    return {
         ...
         * @throws {RequiredError}
         */
        getHistoricalPrice(symbol: string, limit?: number, page?: number, options?: any) {
            return NetworkApiFp(configuration).getHistoricalPrice(symbol, limit, page, options)(fetch, basePath);
        },
        /**
         * This endpoint returns reward and lpp distribution amount since beginning of time
         * @summary Get the historical distribution of rewards and lppd
        ...
        getLppdReward(address: string, options?: any) {
            return NetworkApiFp(configuration).getLppdReward(address, options)(fetch, basePath);
        },
        /**
         *
         * @param {string} symbol
...
export class NetworkApi extends BaseAPI {
     ...
     * @memberof NetworkApi
     */
    public getHistoricalPrice(symbol: string, limit?: number, page?: number, options?: any) {
        return NetworkApiFp(this.configuration).getHistoricalPrice(symbol, limit, page, options)(this.fetch, this.basePath);
    }
    ...
    public getLppdReward(address: string, options?: any) {
        return NetworkApiFp(this.configuration).getLppdReward(address, options)(this.fetch, this.basePath);
    }
...
export const PoolsApiFp = function(configuration?: Configuration) {
    return {
         ...
         * @throws {RequiredError}
         */
        getLiquidityProvider(symbol: string, lpAddress: string, options?: any): (fetch?: FetchAPI, basePath?: string) => Promise<GetLiquidityProviderResponse> {
         ...
         * @throws {RequiredError}
         */
        getLiquidityProviders(symbol: string, options?: any): (fetch?: FetchAPI, basePath?: string) => Promise<Array<GetLiquidityProvidersResponse>> {
         ...
         * @throws {RequiredError}
         */
        getPool(symbol: string, options?: any): (fetch?: FetchAPI, basePath?: string) => Promise<GetPoolResponse> {
         ...
         * @throws {RequiredError}
         */
        getPoolShare(symbol: string, lpAddress: string, options?: any): (fetch?: FetchAPI, basePath?: string) => Promise<PoolShareResponse> {
         ...
         * @throws {RequiredError}
         */
        getPools(options?: any): (fetch?: FetchAPI, basePath?: string) => Promise<Array<GetPoolsResponse>> {
...
export const StatsApiFp = function(configuration?: Configuration) {
    return {
         ...
         * @throws {RequiredError}
         */
        cmcCirculatingSupply(options?: any): (fetch?: FetchAPI, basePath?: string) => Promise<string> {
         ...
         * @throws {RequiredError}
         */
        cmcTotalSupply(options?: any): (fetch?: FetchAPI, basePath?: string) => Promise<string> {
         ...
         * @throws {RequiredError}
         */
        getCirculatingSupply(options?: any): (fetch?: FetchAPI, basePath?: string) => Promise<GetCirculatingSupplyResponse> {
         ...
         * @throws {RequiredError}
         */
        getStakingRewards(options?: any): (fetch?: FetchAPI, basePath?: string) => Promise<InlineResponse200> {
         ...
         * @throws {RequiredError}
         */
        getTotalSupply(options?: any): (fetch?: FetchAPI, basePath?: string) => Promise<GetTotalSupplyResponse> {
...
export const TradesApiFp = function(configuration?: Configuration) {
    return {
         ...
         * @throws {RequiredError}
         */
        getCompetitionRanks(type: string, options?: any): (fetch?: FetchAPI, basePath?: string) => Promise<Array<GetTradeResponse>> {
         ...
         * @throws {RequiredError}
         */
        getCompetitionRanksByToken(token: string, type: string, options?: any): (fetch?: FetchAPI, basePath?: string) => Promise<Array<GetTradeResponse>> {
         ...
         * @throws {RequiredError}
         */
        getTrades(marketPair: string, options?: any): (fetch?: FetchAPI, basePath?: string) => Promise<Array<GetTradeResponse>> {
...
export const ValidatorsApiFp = function(configuration?: Configuration) {
    return {
         ...
         * @throws {RequiredError}
         */
        getDelegator(delegatorAddress: string, options?: any): (fetch?: FetchAPI, basePath?: string) => Promise<GetDelegatorResponse> {
         ...
         * @throws {RequiredError}
         */
        getDelegators(validatorAddress: string, options?: any): (fetch?: FetchAPI, basePath?: string) => Promise<GetDelegatorsResponse> {
         ...
         * @throws {RequiredError}
         */
        getInactiveValidators(options?: any): (fetch?: FetchAPI, basePath?: string) => Promise<Array<GetInactiveValidatorsResponse>> {
         ...
         * @throws {RequiredError}
         */
        getTotalStakedByDelegators(options?: any): (fetch?: FetchAPI, basePath?: string) => Promise<GetTotalStakedByDelegatorsResponse> {
         ...
         * @throws {RequiredError}
         */
        getValidator(validatorAddress: string, options?: any): (fetch?: FetchAPI, basePath?: string) => Promise<GetValidatorResponse> {
