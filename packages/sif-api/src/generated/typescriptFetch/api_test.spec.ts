...
describe("MarginApi", () => {
  ...
  test("getMarginHistory", () => {
    ...
    return expect(instance.getMarginHistory(address, offset, limit, orderBy, sortBy, {})).resolves.toBe(null)
  })
  test("getMarginOpenPosition", () => {
    ...
    const orderBy: string = "orderBy_example"
    const sortBy: string = "sortBy_example"
    return expect(instance.getMarginOpenPosition(address, offset, limit, orderBy, sortBy, {})).resolves.toBe(null)
  })
  test("getMarginOpenPositionBySymbol", () => {
    const address: string = "address_example"
    const poolSymbol: string = "poolSymbol_example"
    const offset: number = 1.2
    const limit: number = 1.2
    const orderBy: string = "orderBy_example"
    const sortBy: string = "sortBy_example"
    return expect(instance.getMarginOpenPositionBySymbol(address, poolSymbol, offset, limit, orderBy, sortBy, {})).resolves.toBe(null)
  })
})
...
describe("NetworkApi", () => {
  ...
  test("getHistoricalPrice", () => {
    ...
    return expect(instance.getHistoricalPrice(symbol, limit, page, {})).resolves.toBe(null)
  })
  test("getLppdReward", () => {
    const address: string = "address_example"
  ...
  test("getNetChange", () => {
    ...
    return expect(instance.getNetChange(symbol, lpAddress, {})).resolves.toBe(null)
  })
  test("getNetworkInfo", () => {
...
describe("PoolsApi", () => {
  ...
  test("getLiquidityProvider", () => {
    const symbol: string = "symbol_example"
    const lpAddress: string = "lpAddress_example"
    return expect(instance.getLiquidityProvider(symbol, lpAddress, {})).resolves.toBe(null)
  })
  test("getLiquidityProviders", () => {
    const symbol: string = "symbol_example"
    return expect(instance.getLiquidityProviders(symbol, {})).resolves.toBe(null)
  })
  test("getPool", () => {
    const symbol: string = "symbol_example"
  ...
  test("getPoolShare", () => {
    const symbol: string = "symbol_example"
    const lpAddress: string = "lpAddress_example"
    return expect(instance.getPoolShare(symbol, lpAddress, {})).resolves.toBe(null)
  })
  test("getPools", () => {
...
describe("TradesApi", () => {
  ...
  test("getCompetitionRanksByToken", () => {
    ...
    const type: string = "type_example"
    return expect(instance.getCompetitionRanksByToken(token, type, {})).resolves.toBe(null)
  })
  test("getTrades", () => {
...
describe("ValidatorsApi", () => {
  ...
  test("getDelegator", () => {
    ...
    return expect(instance.getDelegator(delegatorAddress, {})).resolves.toBe(null)
  })
  test("getDelegators", () => {
    const validatorAddress: string = "validatorAddress_example"
    return expect(instance.getDelegators(validatorAddress, {})).resolves.toBe(null)
  })
  ...
  test("getValidator", () => {
    const validatorAddress: string = "validatorAddress_example"
    return expect(instance.getValidator(validatorAddress, {})).resolves.toBe(null)
  })
  test("getValidators", () => {
