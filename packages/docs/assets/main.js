...
(() => {
  ...
  var Me = (t, e, n, r) => {
    if ((e && typeof e == "object") || typeof e == "function")
      for (let i of Ce(e))
        !Re.call(t, i) && i !== n && ae(t, i, { get: () => e[i], enumerable: !(r = Pe(e, i)) || r.enumerable });
    return t;
  };
  var De = (t, e, n) => (
    (n = t != null ? Qe(Oe(t)) : {}),
...
`,
      ...
      (t.Vector = function (e) {
        ...
        (t.Vector.prototype.dot = function (e) {
          for (
            var n = 0, r = this.elements, i = e.elements, s = r.length, o = i.length, a = 0, u = 0, l = 0, h = 0;
            l < s && h < o;

          )
            (a = r[l]),
              (u = i[h]),
              a < u ? (l += 2) : a > u ? (h += 2) : a == u && ((n += r[l + 1] * i[h + 1]), (l += 2), (h += 2));
          return n;
        }),
      ...
      (t.TokenSet = function () {
        ...
        (t.TokenSet.prototype.intersect = function (e) {
          for (var n = new t.TokenSet(), r = void 0, i = [{ qNode: e, output: n, node: this }]; i.length; ) {
            r = i.pop();
            for (
              var s = Object.keys(r.qNode.edges), o = s.length, a = Object.keys(r.node.edges), u = a.length, l = 0;
              l < o;
              l++
            )
  ...
  function Ae(t, e, n, r) {
    ...
    for (let o = 0; o < s.length; o++) {
      let a = s[o],
        ...
        l = 1;
      u.name.toLowerCase().startsWith(i.toLowerCase()) && (l *= 1 + 1 / (1 + Math.abs(u.name.length - i.length))),
        (a.score *= l);
    }
...
`);
  ...
  var te = class extends k {
    ...
    expand(n = !0) {
      (this.el.open = !0),
        this.animate(this.collapsedHeight, this.expandedHeight, { opening: !0, duration: n ? 300 : 0 });
    }
    collapse(n = !0) {
