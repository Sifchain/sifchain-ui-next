...
const SvgWalletconnectCircleIcon = (props: SVGProps<SVGSVGElement>) => (
  <svg viewBox="0 0 512 512" xmlns="http://www.w3.org/2000/svg" width="1em" height="1em" {...props}>
    <defs>
      <radialGradient cx="0%" cy="50%" fx="0%" fy="50%" r="100%" id="walletconnect-circle-icon_svg__a">
        <stop stopColor="#5D9DF6" offset="0%" />
        <stop stopColor="#006FFF" offset="100%" />
      </radialGradient>
    </defs>
    <g fill="none" fillRule="evenodd">
      <rect fill="url(#walletconnect-circle-icon_svg__a)" width={512} height={512} rx={256} />
      <path
...
export default SvgWalletconnectCircleIcon;
