...
const SvgEthereumCircleIcon = (props: SVGProps<SVGSVGElement>) => (
  ...
  >
    ...
    <path
      d="m6.999 2-3.07 5.093L7 8.907V2ZM6.999 9.488l-.038.046v2.356L7 12l3.071-4.325L7 9.488Z"
      fill="#fff"
    />
    <path
      d="M6.999 12V9.488l-3.07-1.813L7 12ZM6.999 8.907l3.07-1.814-3.07-1.395v3.209Z"
      fill="#fff"
    />
