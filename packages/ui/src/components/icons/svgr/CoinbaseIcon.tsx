...
const SvgCoinbaseIcon = (props: SVGProps<SVGSVGElement>) => (
  <svg
    baseProfile="tiny"
    ...
    {...props}
  >
    <path fill="#0052FF" d="M512 0c282.8 0 512 229.2 512 512s-229.2 512-512 512S0 794.8 0 512 229.2 0 512 0z" />
    <path
      fill="#FFF"
...
export default SvgCoinbaseIcon;
