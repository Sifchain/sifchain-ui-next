...
const SvgBscIcon = (props: SVGProps<SVGSVGElement>) => (
  <svg viewBox="0 0 126.61 126.61" xmlns="http://www.w3.org/2000/svg" width="1em" height="1em" {...props}>
    <g fill="#f3ba2f">
