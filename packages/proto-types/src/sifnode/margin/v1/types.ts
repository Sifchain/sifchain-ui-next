...
export const MTP = {
  ...
  toJSON(message: MTP): unknown {
    ...
    message.interestPaidCollateral !== undefined && (obj.interestPaidCollateral = message.interestPaidCollateral);
    message.interestPaidCustody !== undefined && (obj.interestPaidCustody = message.interestPaidCustody);
    message.interestUnpaidCollateral !== undefined && (obj.interestUnpaidCollateral = message.interestUnpaidCollateral);
