...
export const RewardsBucket = {
  encode(message: RewardsBucket, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
    if (message.denom !== "") {
  ...
  fromPartial<I extends Exact<DeepPartial<RewardsBucket>, I>>(object: I): RewardsBucket {
    const message = createBaseRewardsBucket();
