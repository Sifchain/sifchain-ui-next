...
function createBasePoolShareEstimateReq(): PoolShareEstimateReq {
  return { externalAsset: undefined, nativeAssetAmount: "", externalAssetAmount: "" };
}
...
export const PoolShareEstimateReq = {
  ...
  decode(input: _m0.Reader | Uint8Array, length?: number): PoolShareEstimateReq {
    const reader = input instanceof _m0.Reader ? input : new _m0.Reader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
  ...
  fromPartial<I extends Exact<DeepPartial<PoolShareEstimateReq>, I>>(object: I): PoolShareEstimateReq {
    const message = createBasePoolShareEstimateReq();
...
function createBasePoolShareEstimateRes(): PoolShareEstimateRes {
  return { percentage: "", nativeAssetAmount: "", externalAssetAmount: "", swapInfo: undefined };
}
...
export const PoolShareEstimateRes = {
  ...
  decode(input: _m0.Reader | Uint8Array, length?: number): PoolShareEstimateRes {
    const reader = input instanceof _m0.Reader ? input : new _m0.Reader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
  ...
  toJSON(message: PoolShareEstimateRes): unknown {
    ...
    message.nativeAssetAmount !== undefined && (obj.nativeAssetAmount = message.nativeAssetAmount);
    message.externalAssetAmount !== undefined && (obj.externalAssetAmount = message.externalAssetAmount);
    message.swapInfo !== undefined && (obj.swapInfo = message.swapInfo ? SwapInfo.toJSON(message.swapInfo) : undefined);
    return obj;
  },

  fromPartial<I extends Exact<DeepPartial<PoolShareEstimateRes>, I>>(object: I): PoolShareEstimateRes {
    const message = createBasePoolShareEstimateRes();
    message.percentage = object.percentage ?? "";
    message.nativeAssetAmount = object.nativeAssetAmount ?? "";
    message.externalAssetAmount = object.externalAssetAmount ?? "";
    message.swapInfo =
      object.swapInfo !== undefined && object.swapInfo !== null ? SwapInfo.fromPartial(object.swapInfo) : undefined;
    return message;
  },
};
...
export const RewardsBucketReq = {
  encode(message: RewardsBucketReq, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
    if (message.denom !== "") {
  ...
  fromPartial<I extends Exact<DeepPartial<RewardsBucketReq>, I>>(object: I): RewardsBucketReq {
    const message = createBaseRewardsBucketReq();
...
export const RewardsBucketRes = {
  encode(message: RewardsBucketRes, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
  ...
  toJSON(message: RewardsBucketRes): unknown {
    ...
    message.rewardsBucket !== undefined &&
      (obj.rewardsBucket = message.rewardsBucket ? RewardsBucket.toJSON(message.rewardsBucket) : undefined);
    return obj;
  },

  fromPartial<I extends Exact<DeepPartial<RewardsBucketRes>, I>>(object: I): RewardsBucketRes {
    const message = createBaseRewardsBucketRes();
...
export const AllRewardsBucketReq = {
  encode(message: AllRewardsBucketReq, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
    if (message.pagination !== undefined) {
      PageRequest.encode(message.pagination, writer.uint32(10).fork()).ldelim();
    }
    return writer;
  ...
  fromPartial<I extends Exact<DeepPartial<AllRewardsBucketReq>, I>>(object: I): AllRewardsBucketReq {
    const message = createBaseAllRewardsBucketReq();
    message.pagination =
      object.pagination !== undefined && object.pagination !== null
        ? PageRequest.fromPartial(object.pagination)
...
export const AllRewardsBucketRes = {
  encode(message: AllRewardsBucketRes, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
  ...
  decode(input: _m0.Reader | Uint8Array, length?: number): AllRewardsBucketRes {
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        case 1:
          message.rewardsBucket.push(RewardsBucket.decode(reader, reader.uint32()));
          break;
        case 2:
          message.pagination = PageResponse.decode(reader, reader.uint32());
          break;
  ...
  toJSON(message: AllRewardsBucketRes): unknown {
    ...
    if (message.rewardsBucket) {
      obj.rewardsBucket = message.rewardsBucket.map((e) => (e ? RewardsBucket.toJSON(e) : undefined));
    } else {
      obj.rewardsBucket = [];
    }
    message.pagination !== undefined &&
  ...
  fromPartial<I extends Exact<DeepPartial<AllRewardsBucketRes>, I>>(object: I): AllRewardsBucketRes {
    const message = createBaseAllRewardsBucketRes();
...
export class QueryClientImpl implements Query {
  ...
  GetPoolShareEstimate(request: PoolShareEstimateReq): Promise<PoolShareEstimateRes> {
    ...
    return promise.then((data) => PoolShareEstimateRes.decode(new _m0.Reader(data)));
  }
  ...
  GetRewardsBucket(request: RewardsBucketReq): Promise<RewardsBucketRes> {
    ...
    return promise.then((data) => RewardsBucketRes.decode(new _m0.Reader(data)));
  }
  ...
  GetRewardsBucketAll(request: AllRewardsBucketReq): Promise<AllRewardsBucketRes> {
    ...
    return promise.then((data) => AllRewardsBucketRes.decode(new _m0.Reader(data)));
  }
}
