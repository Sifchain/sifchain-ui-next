...
function createBaseMsgUpdateSwapFeeParamsRequest(): MsgUpdateSwapFeeParamsRequest {
  return { signer: "", defaultSwapFeeRate: "", tokenParams: [] };
}
...
export const MsgUpdateSwapFeeParamsRequest = {
  ...
  decode(input: _m0.Reader | Uint8Array, length?: number): MsgUpdateSwapFeeParamsRequest {
    const reader = input instanceof _m0.Reader ? input : new _m0.Reader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const MsgUpdateSwapFeeParamsResponse = {
  ...
  decode(input: _m0.Reader | Uint8Array, length?: number): MsgUpdateSwapFeeParamsResponse {
    const reader = input instanceof _m0.Reader ? input : new _m0.Reader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
  ...
  fromPartial<I extends Exact<DeepPartial<MsgUpdateSwapFeeParamsResponse>, I>>(_: I): MsgUpdateSwapFeeParamsResponse {
    const message = createBaseMsgUpdateSwapFeeParamsResponse();
    return message;
  },
};
