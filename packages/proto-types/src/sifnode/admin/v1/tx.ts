...
export const MsgSetParams = {
  ...
  fromPartial<I extends Exact<DeepPartial<MsgSetParams>, I>>(object: I): MsgSetParams {
    const message = createBaseMsgSetParams();
    message.signer = object.signer ?? "";
    message.params =
...
export const MsgSetParamsResponse = {
  ...
  decode(input: _m0.Reader | Uint8Array, length?: number): MsgSetParamsResponse {
    const reader = input instanceof _m0.Reader ? input : new _m0.Reader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
  ...
  fromPartial<I extends Exact<DeepPartial<MsgSetParamsResponse>, I>>(_: I): MsgSetParamsResponse {
    const message = createBaseMsgSetParamsResponse();
    return message;
  },
};
...
export class MsgClientImpl implements Msg {
  ...
  SetParams(request: MsgSetParams): Promise<MsgSetParamsResponse> {
    ...
    return promise.then((data) => MsgSetParamsResponse.decode(new _m0.Reader(data)));
  }
}
