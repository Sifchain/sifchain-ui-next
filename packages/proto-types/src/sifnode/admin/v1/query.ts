...
export const ListAccountsRequest = {
  ...
  fromPartial<I extends Exact<DeepPartial<ListAccountsRequest>, I>>(_: I): ListAccountsRequest {
    const message = createBaseListAccountsRequest();
    return message;
  },
};
...
export class QueryClientImpl implements Query {
  ...
  GetParams(request: GetParamsRequest): Promise<GetParamsResponse> {
    ...
    return promise.then((data) => GetParamsResponse.decode(new _m0.Reader(data)));
  }
}
